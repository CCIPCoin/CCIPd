...
//    strUsage += "  -anonymizeCCIPamount=<n>     " + strprintf(_("Keep N PIV anonymized (default: %u)"), 0) + "\n";
...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2015-%i The CCIP Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
