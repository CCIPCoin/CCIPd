...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "CCIP.seed2.fuzzbawls.pw"));    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "CCIP-testnet.seed2.fuzzbawls.pw"));
