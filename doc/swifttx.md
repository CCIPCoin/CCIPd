...
This mechanism has been integrated into Bitcore-Node-CCIP which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CCIP-Project/insight-api-CCIP#web-socket-api](https://github.com/CCIP-Project/insight-api-CCIP#web-socket-api) 
* API: [https://github.com/CCIP-Project/insight-api-CCIP#swifttx-transactions](https://github.com/CCIP-Project/insight-api-CCIP#swifttx-transactions) 
...
By default, the CCIP Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CCIP Core daemon:
