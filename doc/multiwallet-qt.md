...
In order to support loading of multiple wallets in CCIP-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is CCIP.cpp.
...
Changes to CCIP.cpp
----------------------
CCIP.cpp is the entry point into CCIP-qt, and as such, will require some minor modifications to provide hooks for
